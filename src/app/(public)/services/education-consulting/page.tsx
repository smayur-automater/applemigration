...
export const metadata: Metadata = {
  title: "Education Consulting — Find Your Course in Australia",
  description: "Expert education consulting to help you find the right Australian course and institution. CRICOS provider matching and enrolment support.",
};
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
          <nav aria-label="Breadcrumb" className="mb-6">
            <ol className="flex items-center gap-2 text-sm" style={{ color: "rgba(247,245,240,0.6)" }}>
              ...
              <li aria-hidden="true">/</li>
              <li aria-current="page" className="text-white">Education Consulting</li>
            </ol>
          </nav>
          <h1 className="font-display font-bold text-white mb-4" style={{ fontSize: "clamp(2rem, 4vw, 3rem)" }}>
            Education Consulting
          </h1>
          <p className="text-lg mb-8 max-w-2xl" style={{ color: "rgba(247,245,240,0.8)" }}>Find the right course and institution for your goals. We match you with CRICOS-registered providers across Australia.</p>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-[720px] mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-base leading-relaxed mb-6" style={{ color: "var(--color-charcoal)" }}>
            Our MARA-registered agents provide expert guidance across all aspects of Education Consulting applications. 
