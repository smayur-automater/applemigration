...
export const metadata: Metadata = {
  title: "Partner & Family Visas Australia (820, 801, 309)",
  description: "Reunite with your loved ones in Australia. Expert partner and family visa assistance from MARA-registered agents.",
};
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
          <nav aria-label="Breadcrumb" className="mb-6">
            <ol className="flex items-center gap-2 text-sm" style={{ color: "rgba(247,245,240,0.6)" }}>
              ...
              <li aria-hidden="true">/</li>
              <li aria-current="page" className="text-white">Partner & Family Visas</li>
            </ol>
          </nav>
          <h1 className="font-display font-bold text-white mb-4" style={{ fontSize: "clamp(2rem, 4vw, 3rem)" }}>
            Partner & Family Visas
          </h1>
          <p className="text-lg mb-8 max-w-2xl" style={{ color: "rgba(247,245,240,0.8)" }}>Reunite with your loved ones in Australia. We handle partner, spouse, parent, and dependent child visa applications.</p>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-[720px] mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-base leading-relaxed mb-6" style={{ color: "var(--color-charcoal)" }}>
            Our MARA-registered agents provide expert guidance across all aspects of Partner & Family Visas applications. 
